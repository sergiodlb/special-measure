	...
	case 1	% temperature
        switch ico(3)
            ...
            case 1 % set temperature
                %formatSpec = 'TEMP %6.3f %5.3f 0';
                formatSpec = 'TEMP %6.3f 20.0 0'; % FIXME - this is a hack until we can figure out two args for smset
    ...
    case 3	% driven field (one-shot)
        switch ico(3)
            ...
            case 1 % set driven field
                %formatSpec = 'FIELD %6.2f %6.3f 0 1';
                formatSpec = 'FIELD %6.2f 80.0 0 1'; % FIXME - this is a hack until we can figure out two args for smset
                fprintf(smdata.inst(ico(1)).data.inst, formatSpec, val);
            otherwise
                error('Operation not supported');
        end
